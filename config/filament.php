...
return [
    ...
    */
    ...
    'temporary_url_expiration' => now()->addHour(),

    'default_image_driver' => 'gd', // or 'imagick' if installed

    'enable_asset_cache_busting' => true,
    ...
    */
    ...
    'colors' => [
            ...
            'secondary' => 'rgb(88, 132, 226)', // dark gray
            'background' => '#5b55d6', // black
        ],
    ],
